...
abstract class BaseController
{
    ...
    public function error($msg,$callback = null)
    {
        return view('/error', ['msg' => $msg, 'callback' => $callback]);
    }

    public function userLoginRequired()
    {
        return redirect('/index.auth/signin');
    }
