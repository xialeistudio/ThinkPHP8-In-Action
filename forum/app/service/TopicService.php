...
class TopicService extends BaseObject implements ScorePublisher
{
    /**
     * 发表主题
     * 1. 写入主题信息
    ...
    {
        return config('app.params.score.publish_topic');
    }
    ...
    {
        return config('app.params.score.top_topic');
    }
