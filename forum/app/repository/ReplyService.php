...
use app\model\Reply;
use app\model\User;
use app\ScorePublisher;
use app\service\ForumAdminService;
use app\service\ForumService;
use app\service\TopicService;
use app\service\UserScoreLogService;
use Exception;
use think\db\exception\DbException;
use think\facade\Db;
use think\Paginator;

class ReplyService extends BaseObject implements ScorePublisher
{
    /**
     * 发表回复
     * 1. 写入回复信息
    ...
    public function delete($userId, $replyId)
    {
        return Db::transaction(function () use ($userId, $replyId) {
            ...
            if (!$this->allowAccess($userId, $reply)) {
     ...
     * @throws DbException
     */
    public function allowAccess(int $userId, Reply $reply): bool
    {
    ...
    {
        return config('app.params.score.publish_reply');
    }
