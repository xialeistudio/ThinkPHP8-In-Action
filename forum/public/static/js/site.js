var uploadhandlerpath = "/index/upload";


window.rte_file_upload_handler = function rte_file_upload_handler(file, callback, optionalIndex, optionalFiles) {
